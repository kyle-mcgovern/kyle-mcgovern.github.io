...
d3.csv("/data/bayes_oscillibacter.csv", d3.autoType).then(data => {
	cred_plot(g1, data, margin, 650, 430, true, "BpimC: Oscillibacter", 25, -0.4, 0.6);
});
d3.csv("/data/bayes_prevotella.csv", d3.autoType).then(data => {
	cred_plot(g2, data, margin, 650, 430, false, "BpimC: Prevotella", 0, -0.4, 0.5);
});
